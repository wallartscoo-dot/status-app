...
const ACTIONS: { icon: keyof typeof Ionicons.glyphMap; label: string; route?: string }[] = [
  ...
  { icon: "download-outline", label: "My Downloads", route: "/downloads" },
  ...
  return (
    <Screen edges={["top"]}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <GlassSurface style={styles.statsRow} strength="subtle">
        ...
        <GlassSurface style={{ marginTop: spacing.xl }} strength="subtle">
...
const styles = StyleSheet.create({
  ...
  statsRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-around", paddingVertical: spacing.lg },
