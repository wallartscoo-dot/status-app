  ...
  return (
    <Screen edges={["top"]}>
      <FlatList
          ...
          <View style={styles.header}>
            ...
            {!isSelf && (
              <View style={styles.actionsRow}>
                ...
                >
                  <GlassSurface style={styles.messageBtn} strength="subtle" elevated={false}>
        ...
        renderItem={({ item }) => (
          <GlassSurface style={styles.statusCard} strength="subtle" elevated={false}>
...
const styles = StyleSheet.create({
  ...
  actionsRow: { flexDirection: "row", alignItems: "center", gap: spacing.sm, width: "100%", marginTop: spacing.lg, marginBottom: spacing.xl },
  messageBtn: { width: 54, height: 54, borderRadius: radius.lg, alignItems: "center", justifyContent: "center" },
