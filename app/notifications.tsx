      ...
      {loading ? (
        ...
        <FlatList
          ...
          renderItem={({ item }) => {
            ...
            return (
              <Pressable onPress={() => onTapNotification(item)} style={styles.rowWrap}>
                {item.isRead ? row : (
                  <GlassSurface style={styles.row} strength="subtle" elevated={false}>
                    {row}
                  </GlassSurface>
                )}
              </Pressable>
...
const styles = StyleSheet.create({
  ...
  rowWrap: { marginHorizontal: spacing.lg, marginBottom: spacing.sm },
  rowInner: {
    flexDirection: "row",
    gap: spacing.md,
