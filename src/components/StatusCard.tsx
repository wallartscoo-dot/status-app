  ...
  return (
    <Pressable onPress={onPress} style={[styles.card, { width, backgroundColor: theme.surface }, shadow.card]}>
      <View style={styles.thumbWrap}>
        ...
        {/* Download moved here as a small icon (spec update: the message
            button now owns the card's primary full-width action). Still
            shows the same state feedback (progress / saved / retry). */}
        <Pressable
          onPress={(e: any) => {
            e.stopPropagation?.();
            handleDownload();
      ...
      <View style={styles.meta}>
        ...
        {!isOwnStatus && (
          <Pressable onPress={handleMessage} style={[styles.actionRow, { borderColor: theme.border }]}>
